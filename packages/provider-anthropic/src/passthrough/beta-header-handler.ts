// Native/Audited application policy for the `anthropic-beta` request header.
//
...
//   (the provider-hosted computer-use beta family). No other Native semantic
//   hard-deny is authorized (NATIVE_HARD_DENY_EXPANSION=FORBIDDEN).
//
