// Resolve `OpenAI-Beta` request headers against OPENAI_BETA_POLICY.
// Same shape as the Anthropic handler but bound to provider='openai' for
// resolveBeta routing (override loader is provider-scoped).
//
