// Unit tests for the OpenAI provider-native response hop-by-hop header filter.
//
...
// The full hop-by-hop set the OpenAI passthrough route strips from responses
...
describe('filterResponseHeaders (OpenAI provider-native response hop-by-hop policy)', () => {
