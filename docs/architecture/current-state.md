...
| Root integration-only | the identities `GOVAI_INTEGRATION=1` adds (proved set difference, all under `tests/integration/`) | 93 | 1443 |
| Root full integration gate | `pnpm test:integration` (unit + integration; the CI `integration` job) | 241 | 3137 |
