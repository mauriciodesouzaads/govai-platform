...
(
  ...
  # ANY output = the artifact violates the policy and must not be shared.
...
`-name 'dist'` covers both `dist/` and `tests/dist/`; the last three `find`
